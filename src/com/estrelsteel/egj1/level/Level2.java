...
public class Level2 extends GameLevel {
	...
	public SplitWorld loadLevel(Player p, AntiPlayer ap) {
		...
		w.getGoals().add(new Goal(QuickRectangle.location(280, 320 - 256 - 64, 64, 64), 0));
		w.getGoals().add(new Goal(QuickRectangle.location(280, 320 + 256, 64, 64), 1));
		...
		w.getBlocks().add(new Block(QuickRectangle.location(280, 320 - 256, 160, 64), 0));
		w.getAntiBlocks().add(new Block(QuickRectangle.location(280, 320 + 256 - 64, 160, 64), 1));
