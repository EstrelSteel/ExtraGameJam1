...
public class Level4 extends GameLevel {
	...
	public SplitWorld loadLevel(Player p, AntiPlayer ap) {
		...
		w.getBlocks().add(new Block(QuickRectangle.location(0, EGJ1.HEIGHT / 2 + 64, EGJ1.WIDTH, EGJ1.HEIGHT / 2), 2));
		...
		w.getGoals().add(new Goal(QuickRectangle.location(576, 320, 64, 64), 0));
		w.getGoals().add(new Goal(QuickRectangle.location(576, 320 + 64, 64, 64), 1));

		w.getBlocks().add(new Block(QuickRectangle.location(0, 320, 320, 64), 0));
		w.getAntiBlocks().add(new Block(QuickRectangle.location(320, 320, 320, 64), 1));
