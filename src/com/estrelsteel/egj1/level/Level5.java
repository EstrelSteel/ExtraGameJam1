...
//		w.getObjects().add(new Message(QuickRectangle.location(64, 64, 512, 64), 0));
		w.getObjects().add(new Spike(QuickRectangle.location(320, 320 - 64, 64, 64), 0));
		w.getObjects().add(new Spike(QuickRectangle.location(320 + 64, 320 - 64, 64, 64), 0));
		w.getObjects().add(new Spike(QuickRectangle.location(320 + 128, 320 - 64, 64, 64), 0));
		
//		w.getObjects().add(new Spike(QuickRectangle.location(320, 320, 64, 64), 1));
//		w.getObjects().add(new Spike(QuickRectangle.location(320 + 64, 320, 64, 64), 1));
//		w.getObjects().add(new Spike(QuickRectangle.location(320 + 128, 320, 64, 64), 1));
